// crates/ui/src/components/PluginToggleItem.tsx
//
// Example:
//   <PluginToggleItem
//     plugin={{ id: "steering", name: "Steering", version: "0.4.1", state: "running" }}
//     enabled={true}
//     onToggle={(v) => ...}
//     selected={selectedId === "steering"}
//     onSelect={() => setSelectedId("steering")}
//   />
...
export default PluginToggleItem;
