// crates/ui/src/components/FailsafeBanner.tsx
//
// Example:
//   <FailsafeBanner reason="Steering plugin timeout > 200ms" onClear={clearFailsafe} />
//
// One-line danger banner. Border-left accent, no full-bleed red. Soft pulse
// only on the left edge — drawn from var(--danger).
