// crates/ui/src/components/TelemetrySparkline.tsx
//
// Example:
//   <TelemetrySparkline data={speedHistory} accent="brand" />
//
// A single-stroke sparkline. No gradient fill by default; pass `fill` for a
// 14%-opacity tint underneath. No glowing trailing dot — just a small dot.
...
export interface TelemetrySparklineProps {
  ...
  fill?: boolean;       // dezenter Area-Fill darunter
  height?: number;
  unit?: string;
  className?: string;
}
